                                          ...
                                          children: [
                                            ...
                                            Row(
                                              children: [
                                                ...
                                                Text(
                                                  cuisines.cuisinewise[index]["rating"]?.toString() ?? "0.0",
                                                  style: TextStyle(
                                                      fontSize: 15,
                                                      fontFamily: "Gilroy Bold",
                                                      color: notifier.textColor),
                                            ...
                                            SizedBox(
                                              ...
                                              child: Text(
                                                cuisines.cuisinewise[index]["fullAddress"]?.toString() ?? "No address",
                                                style: TextStyle(
                                                    fontSize: 14,
                                            ...
                                            SizedBox(
                                              width: Get.width * 0.53,
                                              child: Text(
                                                cuisines.cuisinewise[index]["shortDescription"]?.toString() ?? "No description",
                                                style: TextStyle(
                                                    fontSize: 14,
                                                    fontFamily: "Gilroy Medium",
                                                    color: greycolor),
                                                        ...
                                                        child: GetBuilder<
                                                          ...
                                                          if (dateFormat ==
                                                              ...
                                                              dateFormat ==
                                                                  "Sunday") {
                                                            currentdiscount =
                                                                cuisines.cuisinewise[index]["fridaySundayOffer"]?.toString() ?? "0";
                                                          } else {
                                                            currentdiscount =
                                                                cuisines.cuisinewise[index]["mondayThursdayOffer"]?.toString() ?? "0";
                                                          }
                                                          return Text(
